...
return  <div style={{top:(index+1) * 30}} className="grid grid-cols-1 md:grid-cols-2 border border-zinc-800 rounded-md overflow-hidden sticky  bg-backGround">
    <div className="col-span-1 p-8 flex flex-col justify-center items-center">
